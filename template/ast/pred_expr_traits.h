...
constexpr auto isTriviallyDefaultConstructible =
    pred<std::is_trivially_default_constructible>();
using IsTriviallyDefaultConstructible =
    decltype(isTriviallyDefaultConstructible);
constexpr auto isTriviallyCopyConstructible =
    pred<std::is_trivially_copy_constructible>();
using IsTriviallyCopyConstructible = decltype(isTriviallyCopyConstructible);
constexpr auto isTriviallyMoveConstructible =
    pred<std::is_trivially_move_constructible>();
using IsTriviallyMoveConstructible = decltype(isTriviallyMoveConstructible);
constexpr auto isTriviallyCopyAssignable =
    pred<std::is_trivially_copy_assignable>();
using IsTriviallyCopyAssignable = decltype(isTriviallyCopyAssignable);
constexpr auto isTriviallyMoveAssignable =
    pred<std::is_trivially_move_assignable>();
using IsTriviallyMoveAssignable = decltype(isTriviallyMoveAssignable);
constexpr auto isNothrowDefaultConstructible =
    pred<std::is_nothrow_default_constructible>();
using IsNothrowDefaultConstructible = decltype(isNothrowDefaultConstructible);
constexpr auto isNothrowCopyConstructible =
    pred<std::is_nothrow_copy_constructible>();
using IsNothrowCopyConstructible = decltype(isNothrowCopyConstructible);
constexpr auto isNothrowMoveConstructible =
    pred<std::is_nothrow_move_constructible>();
using IsNothrowMoveConstructible = decltype(isNothrowMoveConstructible);
constexpr auto isNothrowCopyAssignable =
    pred<std::is_nothrow_copy_assignable>();
using IsNothrowCopyAssignable = decltype(isNothrowCopyAssignable);
constexpr auto isNothrowMoveAssignable =
    pred<std::is_nothrow_move_assignable>();
